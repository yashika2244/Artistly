...
const ArtistsList = () => {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto mt-20">
      <h2 className="text-3xl font-extrabold text-center text-purple-800 mb-8">🎭 Artist Listings</h2>
      ...
      {filteredArtists.length > 0 ? (
        ...
        <p className="text-center text-gray-500 mt-10">No artists found matching your filters.</p>
      )}
    </div>
  );
};
